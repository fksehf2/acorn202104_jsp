...
<body>
	...
	<%if(email.equals("yes")){ %>
		<label>
			<input type="radio" name="email2" value="yes" checked/> 네
		</label>
		<label>
			<input type="radio" name="email2" value="no"/> 아니요
		</label>
	<%}else{ %>
		<label>
			<input type="radio" name="email2" value="yes"/> 네
		</label>
		<label>
			<input type="radio" name="email2" value="no" checked/> 아니요
		</label>
	<%} %>
	<br/>
	관심사 
